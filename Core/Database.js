...
module.exports = class Database extends EventEmitter {
  ...
  connect({host = 'localhost', port, password}) {
    return new Promise((resolve, reject) => {
      ...
      this.redis.on('reconnecting', w => this.client.log('[DB]', 'Reconnecting'))
      this.redis.on('ready', w => this.client.log('[DB]', 'Ready'))
      this.redis.on('connect', w => this.client.log('[DB]', 'Redis connection has started.'))
      this.host = host
      this.port = port
